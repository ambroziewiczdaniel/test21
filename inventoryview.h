...
#include <QWidget>
// #include <QSqlDatabase> // USUNIĘTO! Baza danych przez systemWarehouse
...
public:
    explicit InventoryView(systemWarehouse* system, QWidget *parent = nullptr); // Zmieniono QSqlDatabase& na systemWarehouse*
    ~InventoryView();
